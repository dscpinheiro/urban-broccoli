...
namespace NameGenerator
{
    ...
    class Program
    {
        static void Main()
        {
            var leftIndex = _random.Next(_left.Count);
            var rightIndex = _random.Next(_right.Count);
        ...
        private static readonly List<string> _left = new List<string>
        {
            "admiring",
            "adoring",
            "affectionate",
        ...
        private static readonly List<string> _right = new List<string>
        {
